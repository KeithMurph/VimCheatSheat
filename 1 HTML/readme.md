...
<hr>
The building blocks of a modern website includes
 `HTML` 
 which provides stucture to what the user sees, `CSS` to style what the user sees and `JavaScript` which adds interaction for the user.
<hr>
